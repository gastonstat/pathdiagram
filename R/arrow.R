...
#'
#'@param from An object of either class \code{"manifest"} or \code{"latent"}. This
#'object is the origin of the arrow. 
#'@param to An object of either class \code{"manifest"} or \code{"latent"}. This
#'object is the destination of the arrow.
#'@param start Character string to specify the starting direction of the arrow. Options
#'are \code{"north"}, \code{"south"}, \code{"east"}, \code{"west"}.
#'@param end Character string to specify the ending direction of the arrow. Options
#'are \code{"north"}, \code{"south"}, \code{"east"}, \code{"west"}.
...
#'@param code integer code, determining kind of arrows to be drawn.
#'@param col color of the arrow.
#'@param lwd width of the arrow.
#'@param ... other arguments passed on to \code{arrows}.
